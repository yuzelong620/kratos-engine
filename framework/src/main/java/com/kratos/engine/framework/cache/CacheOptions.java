...
public class CacheOptions {
    ...
    private final static int DEFAULT_EXPIRE_AFTER_ACCESS_SECONDS = (int) (24 * TimeUtil.ONE_HOUR / TimeUtil.ONE_MILLSECOND);
    private final static int DEFAULT_EXPIRE_AFTER_WRITE_SECONDS = (int) (24 * TimeUtil.ONE_HOUR / TimeUtil.ONE_MILLSECOND);
