...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'content', minWidth:80, align:'center', title:'评论内容'}
      ...
      ,{field:'replieNum', title:'操作', align:'center', width:125, templet: '#barDemo'}
    ]]
    ,page:{
  ...
  table.on('tool(recoverComment)', function(obj){
	    $.ajax({
			url: "/gm/removeDeity/" + obj.data.id + "",
			type: 'get',
			dataType: "json",
