...
public class ALiYunOssService {
		public static String aliyunOssREGION_CN_HANGZHOU = "cn-hangzhou";
		public static String aliyunOssAccessKeyID = "LTAIdIexD6WmdmcM";
		public static String aliyunOssAccessKeySecret = "MMiWqyckFz01iyHQKcOwhMn3gC7iAG";
		public static String aliyunOssSTS_API_VERSION = "2015-04-01";
		public static String aliyunOssRoleArn = "acs:ram::1745806671943311:role/aliyunosstokengeneratorrole";
		public static String aliyunOssPolicyFile = "policy/all_policy.txt";
		public static int aliyunOssTokenExpireTime = 60;
